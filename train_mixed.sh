...
CUDA_VISIBLE_DEVICES=1,2,3 python -u train.py --name mixThingswithChairsSDHom-lr10-6  --stage mixThingswithChairsSDHom --validation sintel --restore_ckpt models/raft-things.pth --gpus 0 1 2 --num_steps 50000 --batch_size 32 --lr 0.00001 --image_size 384 512 --wdecay 0.00001 --gamma=0.85 --mixed_precision
