...
class KLens(Dataset):
    def __init__(self, root_path="/data2/opticalflow/KLENS/images/", split="train", ref="", meas="", filenumberlist=["0030","1106","1113","1132","1134","1167","1173"],root_path2="/data2/opticalflow/KLENS/pins/",):
        ...
        file_list['train'].extend( [[os.path.join(root_path,"KLE_"+filenum+".jpg4.png"),os.path.join(root_path,"KLE_"+filenum+".jpg5.png")] for filenum in filenumberlist])
        file_list['valid'] = []
        file_list['test'].extend([[os.path.join(root_path,"KLE_"+filenum+".jpg4.png"),os.path.join(root_path,"KLE_"+filenum+".jpg5.png")] for filenum in filenumberlist])
        file_list['train+valid'].extend([[os.path.join(root_path,"KLE_"+filenum+".jpg4.png"),os.path.join(root_path,"KLE_"+filenum+".jpg5.png")] for filenum in filenumberlist])
        file_list["train"].extend([[os.path.join(root_path,"KLE_0309_exp_sub5.jpg"),os.path.join(root_path,"KLE_0309_exp_sub6.jpg")],[os.path.join(root_path,"KLE_0730_sub5.jpg"),os.path.join(root_path,"KLE_0730_sub6.jpg")],[os.path.join(root_path,"KLE_0747_sub5.jpg"),os.path.join(root_path,"KLE_0747_sub6.jpg")],[os.path.join(root_path,"KLE_9797clean_sub5.jpg"),os.path.join(root_path,"KLE_9797clean_sub6.jpg")],[os.path.join(root_path,"KLE_9803clean_sub5.jpg"),os.path.join(root_path,"KLE_9803clean_sub6.jpg")],[os.path.join(root_path,"NKM_0063_sub5.jpg"),os.path.join(root_path,"NKM_0063_sub6.jpg")],[os.path.join(root_path,"NKM_0109_sub5.jpg"),os.path.join(root_path,"NKM_0109_sub6.jpg")],[os.path.join(root_path,"scene_1_sub5.jpg"),os.path.join(root_path,"scene_1_sub6.jpg")],[os.path.join(root_path,"DSC_0608_sub2.jpg"),os.path.join(root_path,"DSC_0608_sub3.jpg")],[os.path.join(root_path,"DSC_0608_sub3.jpg"),os.path.join(root_path,"DSC_0608_sub2.jpg")],[os.path.join(root_path,"DSC_0608_sub2.jpg"),os.path.join(root_path,"DSC_0608_sub4.jpg")],[os.path.join(root_path,"DSC_0608_sub4.jpg"),os.path.join(root_path,"DSC_0608_sub2.jpg")],[os.path.join(root_path,"DSC_0608_sub2.jpg"),os.path.join(root_path,"DSC_0608_sub5.jpg")],[os.path.join(root_path,"DSC_0608_sub5.jpg"),os.path.join(root_path,"DSC_0608_sub2.jpg")],[os.path.join(root_path,"DSC_0608_sub2.jpg"),os.path.join(root_path,"DSC_0608_sub6.jpg")],[os.path.join(root_path,"DSC_0608_sub6.jpg"),os.path.join(root_path,"DSC_0608_sub2.jpg")]])
